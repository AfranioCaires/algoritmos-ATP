...
int main() {
    ...
    float desconto = total * 0.9;
    
    cout << "voce recebeu um desconto de: " << (total - desconto) << " reais" << endl;
    
    cout << "Novo valor para pagar: " << desconto << " reais" << endl;
    
    cin >> pagamento;
    
    troco = pagamento - desconto;
    
    cout << "O seu troco e de " << troco << " reais";
